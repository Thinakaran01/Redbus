...
def extract_bus_details():
    bus_data = []
    MAX_RECORDS = 40
    URL = "https://www.redbus.in/bus-tickets/calangute-goa-to-panaji?fromCityId=253650&toCityId=260317&fromCityName=Calangute%20(goa)&toCityName=Panaji&busType=Any&onward=20-Feb-2025"
...
def store_data_in_db(bus_data):
    try:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS ktclinfo (
        ...
        insert_query = """
        INSERT INTO ktclinfo (Bus_name, Bus_type, Departing_time, Duration, Reaching_time, Star_rating, Price, Seat_availability)
