...
def store_data_in_db(bus_data):
    try:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS tgsrtcinfo (
        ...
        insert_query = """
        INSERT INTO tgsrtcinfo (Bus_name, Bus_type, Departing_time, Duration, Reaching_time, Star_rating, Price, Seat_availability)
