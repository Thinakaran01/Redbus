...
def extract_bus_details():
    bus_data = []
    MAX_RECORDS = 40
    URL = "https://www.redbus.in/bus-tickets/kozhikode-to-ernakulam?fromCityId=74661&toCityId=216&fromCityName=Kozhikode&toCityName=Ernakulam&busType=Any&onward=20-Feb-2025"
...
def store_data_in_db(bus_data):
    try:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS ksrtcinfo (
        ...
        insert_query = """
        INSERT INTO ksrtcinfo (Bus_name, Bus_type, Departing_time, Duration, Reaching_time, Star_rating, Price, Seat_availability)
