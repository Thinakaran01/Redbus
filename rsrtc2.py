...
def extract_bus_details():
    bus_data = []
    MAX_RECORDS = 40
    URL = "https://www.redbus.in/bus-tickets/jodhpur-to-ajmer?fromCityId=1169&toCityId=808&fromCityName=Jodhpur&toCityName=Ajmer&busType=Any&srcCountry=IND&destCountry=IND&onward=27-Nov-2024"
    ...
    try:
        ...
        scroll_pause_time = 3  # Pause after each scroll
        for _ in range(10):  
...
def store_data_in_db(bus_data):
    try:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS rsrtcinfo (
        ...
        insert_query = """
        INSERT INTO rsrtcinfo (Bus_name, Bus_type, Departing_time, Duration, Reaching_time, Star_rating, Price, Seat_availability)
